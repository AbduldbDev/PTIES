        ...
        <table class="email-container" width="100%" cellpadding="0" cellspacing="0" border="0">
            ...
            <tr>
                <td class="content">
                    ...
                    <p>
                        Congratulations! Your application to become a seller with
                    ...
                    <div class="alert-box">
                        <p>
                            🎉 You can now log in to your seller dashboard and start adding
                            your products to the marketplace.
                        </p>
                    </div>

                    <h2 style="color: #083ec1; font-size: 18px; margin-top: 25px">
                        Important Reminder
                    </h2>
                    <p>
                        Please note that while your seller account is now active,
                        <strong>each product you upload or update will still require admin
                            approval</strong>
                        before appearing publicly on the platform. This helps ensure that
                        all listings meet the quality and authenticity standards of Pakil
                        Tourism.
                    </p>
                    ...
                    <p>
                        You can now access your seller dashboard to begin managing your
