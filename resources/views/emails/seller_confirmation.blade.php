...
<head>
    ...
    <title>Seller Application Confirmation</title>
...
<body>
    <center class="container">
        <table class="email-container" width="100%" cellpadding="0" cellspacing="0" border="0">
            ...
            <tr>
                <td class="content">
                    <h1>Thank You for Applying as a Seller!</h1>
                    <p>Hi <strong>{{ $seller['owner_name'] }}</strong>,</p>
                    <p>
                        We have received your seller application. Our team at
                        <strong>PTIEs (Pakil Tourism Information & Engagement System)</strong>
                        will now review your submission.
                    </p>

                    <div class="alert-box">
                        <p>
                            <strong>⏳ Please wait:</strong> Approval typically takes 1–3
                            business days. You will receive an update via email once your
                            account is reviewed.
                        </p>
                    </div>
                    ...
                    <div class="details-box">
                        ...
                        <div class="detail-row">
                            ...
                            <div class="detail-value">{{ $seller['owner_name'] }}</div>
                        </div>
                        <div class="detail-row">
                    ...
                    <p>
                        If we require more information, our team will reach out through
