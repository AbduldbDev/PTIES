...
type PageProps = {
    ...
    items: PaginatedResponse<LogsProps>;
};
...
export default function AllHotilines() {
    ...
    const columns: SortableColumn[] = [
        ...
        { key: 'seller.business_name', label: 'Business Name', sortable: false },
    ...
    return (
        <>
            ...
            <AppWrapper>
                ...
                <PageBreadcrumb pageTitle="Seller Approval Logs" />
                                            ...
                                            sortedItems.map((Seller) => (
                                                <TableRow key={Seller.id}>
                                                    <TableCell className="border border-gray-100 px-4 py-3 text-start text-theme-sm text-gray-500 dark:border-white/[0.05] dark:text-gray-400">
                                                        {Seller.user.profile.last_name}, {Seller.user.profile.first_name}
                                                    </TableCell>
                                                    <TableCell className="border border-gray-100 px-4 py-3 text-start text-theme-sm text-gray-500 dark:border-white/[0.05] dark:text-gray-400">
                                                    ...
                                                    <TableCell className="border border-gray-100 px-4 py-3 text-start text-theme-sm text-gray-500 dark:border-white/[0.05] dark:text-gray-400">
                                                        <span
                                                            className={`inline-flex items-center gap-1.5 rounded-full px-2.5 py-0.5 text-xs font-medium ${
                                                                Seller.status === 'approve' || Seller.status === 'Approve'
                                                    ...
                                                    <TableCell className="border border-gray-100 px-4 py-3 text-start text-theme-sm text-gray-500 capitalize dark:border-white/[0.05] dark:text-gray-400">
                                                        <div className="col-span-1 flex justify-center">
                                                            <div className="flex w-full items-center justify-center gap-2">
                                                                <button
                                                                    aria-label="Edit-btn"
                                                                    onClick={() => handleView(Seller.seller_id)}
