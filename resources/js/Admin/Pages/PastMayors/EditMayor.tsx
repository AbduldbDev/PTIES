...
export default function GuideCreateForm() {
    ...
    const [start, end] = item.term ? item.term.split(' - ') : ['', ''];
    ...
    const handleSubmit = (e: FormEvent) => {
        ...
        const requiredFields: (keyof FormData)[] = ['name', 'position', 'start_term', 'end_term'];
        ...
        form.post(`/Admin/past-mayor/update/${item.id}`, {
            forceFormData: true,
            onSuccess: () => {
                form.reset();
                form.clearErrors();
                    ...
                    <div className="grid grid-cols-1 gap-10 xl:grid-cols-2">
                        <div>
                            <ComponentCard title="Add Past Mayor">
                                ...
                                >
                                    {form.processing ? 'Processing...' : 'Update Past mayor'}
                                </button>
                            </ComponentCard>
                        </div>
                    </div>
