...
export default function GuideCreateForm() {
    ...
    const form = useForm<FormData>({
        ...
        is_leader: item.is_leader ? 'head' : 'member',
    });
    ...
    const handleSubmit = (e: FormEvent) => {
        ...
        form.post(`/Admin/structure/members/update/${item.id}`, {
            forceFormData: true,
            onSuccess: () => {
                form.reset();
                form.clearErrors();
            ...
            <AppWrapper>
                ...
                <form onSubmit={handleSubmit}>
                    <div className="grid grid-cols-1 gap-10 xl:grid-cols-2">
                        <ComponentCard title="Edit Department Member">
                            <InputField
                                type="text"
                                label="Member Name"
                                name="name"
                            ...
                            >
                                {form.processing ? 'Processing...' : 'Update Department Member'}
                            </button>
                        </ComponentCard>
                    </div>
                </form>
