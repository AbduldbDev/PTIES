...
type PageProps = {
    ...
    items: PaginatedResponse<PostProps>;
};
...
export default function Home() {
    const { flash, errors, items, text } = usePage<PageProps>().props;
    const form = useForm();
    ...
    const handleView = (id: any) => {
        router.get(`/Admin/social-wall/view/${id}`);
    };

    const columns: SortableColumn[] = [
        { key: 'post_id', label: 'Post ID', sortable: true },
        { key: 'user.email', label: 'Poseted By', sortable: true },
        { key: 'caption', label: 'Contact', sortable: true },
        ...
        <>
            ...
            <AppWrapper>
                ...
                <div className="grid grid-cols-1 gap-10 xl:grid-cols-1">
                    <ComponentCard title={`${text} Posts`}>
                        <TableControls
                                    ...
                                    <TableBody className="divide-y divide-gray-100 dark:divide-white/[0.05]">
                                        {sortedItems.length > 0 ? (
                                            ...
                                            <TableRow>
                                                ...
                                                >
                                                    {searchTerm ? `No ${text} Post found matching "${searchTerm}"` : `No ${text} Post available`}
                                                </TableCell>
                                            </TableRow>
                                        )}
                                    </TableBody>
