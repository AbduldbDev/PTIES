...
export default function AllHotilines() {
    ...
    const {
    ...
    } = useTableManagement<HotlinesProps>({
        data: items.data,
        ...
        customSearchFilter: (item, searchTerm) => {
            ...
            return (
                ...
                item.hotline.toLowerCase().includes(searchLower)
            );
        },
    });
    ...
    const columns: SortableColumn[] = [
        { key: 'name', label: 'Hotline Name', sortable: true },
        { key: 'category', label: 'Category', sortable: false },
        { key: 'hotlines', label: 'Hotlines', sortable: false },
