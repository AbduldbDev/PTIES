...
export default function GuideCreateForm() {
    ...
    const handleSubmit = (e: FormEvent) => {
        ...
        form.post('/Admin/officials/create', {
            forceFormData: true,
            onSuccess: () => {
                form.reset();
                form.clearErrors();
            ...
            <AppWrapper>
                ...
                <form onSubmit={handleSubmit}>
                    <div className="grid grid-cols-1 gap-10 xl:grid-cols-2">
                        <div>
                            <ComponentCard title="Add New Official">
                                <InputField
                                    type="text"
                                    label="Name"
                                    name="name"
                                ...
                                {form.data.position === 'other' && (
                                    <InputField
                                        type="text"
                                        label="Custom Position"
                                        name="customPosition"
                                        required={true}
                                        value={form.data.customPosition || ''}
                    ...
                    >
                        {form.processing ? 'Processing...' : 'Add New Official'}
                    </button>
                </form>
            </AppWrapper>
        </>
