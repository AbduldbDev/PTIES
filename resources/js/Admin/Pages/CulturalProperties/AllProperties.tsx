...
export default function Home() {
    ...
    const handleDelete = (id: number) => {
        form.delete(`/Admin/cultural-properties/delete/${id}`);
    };

    const handleView = (id: any) => {
        router.get(`/Admin/cultural-properties/edit/${id}`);
    };
    ...
    return (
        <>
            ...
            <AppWrapper>
                ...
                <PageBreadcrumb pageTitle="Cultural Property Management" />

                <div className="grid grid-cols-1 gap-10 xl:grid-cols-1">
                    <ComponentCard title="All Cultural Properties">
                        <TableControls
                                    ...
                                    <TableBody className="divide-y divide-gray-100 dark:divide-white/[0.05]">
                                        {sortedItems.length > 0 ? (
                                            sortedItems.map((Property) => {
                                                const [catIcon, catLabel] = Property.category
                                                    ? Property.category.split('|')
                                                    : ['', Property.category]; // fallback if no "|"
                                                        ...
                                                        <TableCell className="border border-gray-100 px-4 py-3 text-start text-theme-sm text-gray-500 capitalize dark:border-white/[0.05] dark:text-gray-400">
                                                            <div className="col-span-1 flex justify-center">
                                                                <div className="flex w-full items-center justify-center gap-2">
                                                                    <DeleteConfirm
                                                                        onDeleteConfirmed={() => handleDelete(Property.id)}
                                                                        message={`Are you sure you want to delete Cultural Property named ${Property.name}?`}
                                                                    />
                                                                    <button
                                                                        aria-label="Edit-btn"
                                            ...
                                            <TableRow>
                                                ...
                                                >
                                                    {searchTerm
                                                        ? `No Cultural Property found matching "${searchTerm}"`
                                                        : 'No Cultural Property available'}
                                                </TableCell>
                                            </TableRow>
                                        )}
                                    </TableBody>
