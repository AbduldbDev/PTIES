...
export default function GuideCreateForm() {
    ...
    const handleSubmit = (e: FormEvent) => {
        ...
        const requiredFields: (keyof FormData)[] = ['name', 'category', 'description', 'points', 'image'];
        ...
        form.post('/Admin/rewards/create', {
            forceFormData: true,
            onSuccess: () => {
                form.reset();
                form.clearErrors();
            ...
            <AppWrapper>
                ...
                <form onSubmit={handleSubmit}>
                    <div className="grid grid-cols-1 gap-10 xl:grid-cols-2">
                        <ComponentCard title="Add New Reward">
                            <InputField
                                type="text"
                                label="Reward  Name"
                                name="name"
                            ...
                            >
                                {form.processing ? 'Processing...' : 'Add Gamification Reward'}
                            </button>
                        </ComponentCard>
                    </div>
                </form>
