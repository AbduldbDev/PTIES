...
type PageProps = {
    ...
    items: PaginatedResponse<BannerItem>;
};
...
export default function Banners() {
    ...
    const columns: SortableColumn[] = [
        { key: 'key', label: 'Page Name', sortable: true },
                ...
                <div className="grid grid-cols-1 gap-10 xl:grid-cols-1">
                    <ComponentCard title="All Banners">
                        <TableControls
                            ...
                            searchPlaceholder="Search page banner..."
                        />
                                    ...
                                    <TableBody className="divide-y divide-gray-100 dark:divide-white/[0.05]">
                                        {sortedItems.length > 0 ? (
                                            ...
                                            <TableRow>
                                                ...
                                                >
                                                    {searchTerm ? `No Page Banner found matching "${searchTerm}"` : 'No Page Banner available'}
                                                </TableCell>
                                            </TableRow>
                                        )}
                                    </TableBody>
