...
export default function GuideCreateForm() {
    ...
    const handleSubmit = (e: FormEvent) => {
        ...
        const requiredFields: (keyof FormData)[] = ['date', 'title', 'description'];
        ...
        form.post(`/Admin/cms/pakil-history/update/${item.id}`, {
            forceFormData: true,
            onSuccess: () => {
                form.reset();
                form.clearErrors();
        ...
        <>
            ...
            <AppWrapper>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    >
                        {form.processing ? 'Processing...' : 'Update Pakil History'}
                    </button>
                </form>
            </AppWrapper>
        </>
