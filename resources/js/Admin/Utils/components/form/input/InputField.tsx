        ...
        <div className={`relative mb-7 ${className}`}>
            ...
            <div className="relative">
                <input
                    ...
                    className={`dark:bg-dark-900 shadow-theme-xs w-full rounded-lg border bg-transparent px-4 py-2.5 pr-10 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 ${getBorderClasses()}`}
                ...
                {isTouched && !error && !externalError && value && (
                    <span className="absolute top-1/2 right-3.5 -translate-y-1/2">
                        <path
                            fill-rule="evenodd"
                            clip-rule="evenodd"
