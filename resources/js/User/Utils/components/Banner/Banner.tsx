...
const Banner: React.FC<BannerProps> = ({ title, subtitle, className = '', desc = '', imageSrc }) => {
    ...
    return (
        <div className="relative h-64 overflow-hidden md:h-96">
            <img src={imageSrc} alt="City Skyline" className="h-full w-full object-cover object-center" data-aos="zoom-out" data-aos-duration="800" />
            ...
            <div className="absolute inset-0 flex items-end pb-8 md:pb-20">
                <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="text-left">
                        <div className="mb-2 inline-flex items-center" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <h3 className="mb-2 text-2xl font-bold text-white md:text-3xl lg:text-4xl" data-aos="fade-up" data-aos-delay="400">
                            {words.length > 1 ? (
                                <>
                        ...
                        {desc && (
                            <p className="max-w-lg text-sm text-white/90 md:text-base" data-aos="fade-up" data-aos-delay="600">
                                {desc}
                            </p>
                        )}
                    </div>
