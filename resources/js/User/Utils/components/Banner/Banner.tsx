...
const Banner: React.FC<BannerProps> = ({ title, subtitle, className = '', desc = '', imageSrc }) => {
    ...
    return (
        <div className="full-width-banner relative h-96 overflow-hidden">
                ...
                <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="text-left">
                        <div className="mb-2 inline-flex items-center">
                            <div className="mr-2 h-1 w-6 rounded-full bg-secondary"></div>
                            <h2 className="text-xs font-semibold tracking-wider text-white uppercase">{title}</h2>
                            <div className="ml-2 h-1 w-6 rounded-full bg-secondary"></div>
                        </div>
                        ...
                        <p className="max-w-lg text-white/90">{desc}</p>
                    </div>
                </div>
            </div>
        </div>
