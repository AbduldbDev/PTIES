...
export default function Hotlines({ hotlines, index }: Props) {
    ...
    return (
        ...
        >
            ...
            <div className="flex-1 space-y-2 pl-11">
                ...
                <div className="flex items-start text-sm">
                    <div className="mt-0.5 mr-2 flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full bg-primary/10">
                        <i className="fas fa-map-marker-alt text-xs text-primary"></i>
                    </div>
                    <span className="flex-1">{hotlines.location}</span>
                </div>
            </div>
