    ...
    return (
        <>
            <section className="hero-clip-path relative flex min-h-[100vh] items-center justify-center overflow-hidden bg-white pt-20 md:min-h-screen md:pt-0">
                ...
                <div className="relative z-10 container mx-auto px-4 py-8 md:px-6 md:py-12 lg:py-20">
                    <div className="flex flex-col items-center gap-6 lg:flex-row lg:gap-10 xl:gap-12">
                        <div className="text-center lg:w-1/2 lg:text-left">
                            <div className="mb-3 flex justify-center md:mb-4 lg:justify-start" data-aos="fade-down" data-aos-delay="200">
                            ...
                            <h1
                                className="mb-2 text-2xl leading-tight font-bold text-white sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl"
                                data-aos="fade-right"
                                data-aos-delay="300"
                            >
                            ...
                            <h2
                                className="mb-3 text-2xl font-semibold text-white md:text-2xl lg:text-3xl xl:text-4xl"
                                data-aos="fade-right"
                                data-aos-delay="400"
                            >
                                {content.subtitle}
                            ...
                            <p
                                className="mx-auto mb-4 max-w-xl font-custom text-lg text-white/90 italic md:text-base lg:mx-0 lg:mb-6 lg:text-3xl"
                                data-aos="fade-right"
                                data-aos-delay="500"
                            >
                            ...
                            <div
                                className="flex flex-col justify-center gap-2 sm:flex-row sm:gap-3 lg:justify-start"
                                data-aos="fade-up"
                                data-aos-delay="600"
                            >
                                <a
                            ...
                            <div
                                className="mt-6 flex flex-wrap justify-center gap-2 md:gap-3 lg:justify-start"
                                data-aos="fade-up"
                                data-aos-delay="700"
                            >
                        ...
                        <div className="relative mt-4 flex justify-center lg:mt-0 lg:w-1/2" data-aos="fade-left" data-aos-delay="400">
                            <div className="floating relative w-full max-w-[280px] sm:max-w-xs md:max-w-sm lg:max-w-md">
                                ...
                                <div
                                    className="absolute -bottom-3 -left-3 rounded-lg bg-white p-2 shadow-lg sm:-bottom-4 sm:-left-4 sm:rounded-xl sm:p-3 md:-bottom-5 md:-left-5 md:p-4"
                                    data-aos="fade-right"
                                    data-aos-delay="800"
                                >
                                ...
                                <div
                                    className="absolute -top-3 -right-3 rounded-full bg-secondary p-2 shadow-lg sm:-top-4 sm:-right-4 sm:p-2.5 md:-top-5 md:-right-5 md:p-3"
                                    data-aos="fade-left"
                                    data-aos-delay="800"
                                >
                ...
                <div
                    className="absolute bottom-5 left-1/2 -translate-x-1/2 transform animate-bounce sm:bottom-10"
                    data-aos="fade-up"
                    data-aos-delay="1000"
                >
