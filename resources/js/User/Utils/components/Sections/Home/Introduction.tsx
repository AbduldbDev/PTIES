                ...
                <div className="flex flex-col gap-8 lg:flex-row lg:gap-10 xl:gap-12">
                    ...
                    <div className="lg:w-1/2">
                        <div className="group relative">
                            <div className="absolute -inset-1 rounded-lg bg-primary/20 blur-md transition duration-300 group-hover:blur-lg md:-inset-2 md:rounded-xl" />
                            <img
                                src={mainImage}
                                alt="Pakil Town View"
                                ...
                                loading="lazy"
                            />
                            <div className="absolute -right-3 -bottom-3 hidden rounded-lg border border-gray-100 bg-white p-3 shadow-md md:-right-4 md:-bottom-4 md:block md:rounded-xl md:p-4 lg:-right-5 lg:-bottom-5">
                    ...
                    {/* Content Section */}
                    <div className="lg:w-1/2">
                        <div className="prose prose-sm md:prose-lg mb-6 rounded-lg bg-white/80 p-5 shadow-md backdrop-blur-sm md:mb-8 md:rounded-xl md:p-6 lg:p-8">
                            ...
                            <h3 className="text-dark mb-4 text-xl font-bold md:mb-6 md:text-2xl lg:text-3xl xl:text-4xl">
                                <span className="text-primary">{content.title}</span>
                            </h3>

                            {paragraphs.map((paragraph, index) => (
                                <p key={index} className="mb-3 text-sm text-gray-700 md:mb-4 md:text-base">
                                    {paragraph}
                                </p>
                            ))}
                        </div>
                        ...
                        {content.highlights && content.highlights.length > 0 && (
                            <div className="mb-6 rounded-r-md border-l-4 border-primary bg-primary/5 p-3 md:mb-8 md:rounded-r-lg md:p-4">
                                <h4 className="mb-2 flex items-center text-sm font-bold text-primary md:mb-3 md:text-base">
                        ...
                        <div className="rounded-md border border-gray-200 bg-gradient-to-r from-primary/10 to-accent/10 p-4 md:rounded-lg md:p-5">
                            <div className="flex flex-col items-center md:flex-row">
                                <div className="mb-3 md:mr-4 md:mb-0">
                                    <i className="fas fa-mountain text-2xl text-primary md:text-3xl lg:text-4xl" />
                                </div>
                                <div>
                                    <h4 className="text-dark mb-1 text-sm font-bold md:text-base">Explore Nature's Beauty</h4>
                                    ...
                                    <a href="#" className="flex items-center text-xs font-medium text-primary hover:text-primary/80 md:text-sm">
