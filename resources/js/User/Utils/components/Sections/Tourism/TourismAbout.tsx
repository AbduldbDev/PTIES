        ...
        <>
            <div className="flex flex-col items-start gap-12 lg:flex-row">
                ...
                <div className="lg:w-1/2">
                    <div className="group relative" data-aos="fade-right" data-aos-duration="800">
                        ...
                        />
                        <div
                            className="absolute -right-5 -bottom-5 hidden rounded-xl border border-gray-100 bg-white p-4 shadow-lg md:block"
                            data-aos="zoom-in"
                            data-aos-delay="600"
                    ...
                    <div className="mt-6 grid grid-cols-3 gap-4" data-aos="fade-up" data-aos-delay="400">
                ...
                {/* Content Section */}
                <div className="lg:w-1/2">
                    <div className="prose prose-lg mb-8 text-gray-600" data-aos="fade-left" data-aos-duration="800">
                        {paragraphs.map((paragraph, index) => (
                            <p key={index} className="mb-4 text-gray-700" data-aos="fade-up" data-aos-delay={index * 100}>
                                {paragraph}
                            </p>
                        ))}
                    </div>
                    ...
                    {content.goals && content.goals.length > 0 && (
                        <div className="mb-8" data-aos="fade-up" data-aos-delay="300">
                            <h4 className="mb-4 flex items-center text-xl font-bold text-primary" data-aos="fade-right" data-aos-delay="200">
                    ...
                    {content.responsibilities && content.responsibilities.length > 0 && (
                        <div data-aos="fade-up" data-aos-delay="400">
                            <h4 className="mb-4 flex items-center text-xl font-bold text-primary" data-aos="fade-right" data-aos-delay="300">
                            ...
                            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                {content.responsibilities.map((responsibility, index) => (
                                    <div
                                        key={index}
                                        className="rounded-lg border border-gray-200 bg-white/80 p-4 backdrop-blur-sm"
                                        data-aos="zoom-in"
