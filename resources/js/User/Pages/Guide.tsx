            ...
            <section className="py-20">
                <div className="container mx-auto max-w-5xl px-6">
                    <div className="mb-16">
                        <div className="mb-12 text-center">
                            <div className="mb-4 inline-flex items-center">
                                ...
                                <h2 className="text-sm font-semibold tracking-wider text-primary uppercase">Essentials</h2>
                                <div className="ml-3 h-1 w-8 rounded-full bg-secondary"></div>
                            </div>
                            <h3 className="text-dark mb-4 text-3xl font-bold md:text-4xl">
                                <span className="text-primary">Quick</span> Facts
                            </h3>
                        </div>
                    ...
                    <div className="mb-16">
                        <div className="mb-12 text-center">
                            <h3 className="text-dark mb-4 text-3xl font-bold md:text-4xl">
                                <span className="text-primary">Where</span> to Stay
                            </h3>
                            <p className="mx-auto max-w-3xl text-lg text-gray-600">Comfortable accommodations in Pakil</p>
                        </div>
                    ...
                    <div className="mb-16">
                        <div className="mb-12 text-center">
                            <h3 className="text-dark mb-4 text-3xl font-bold md:text-4xl">
                                <span className="text-primary">Where</span> to Eat
                            </h3>
                            <p className="mx-auto max-w-3xl text-lg text-gray-600">Local dining establishments offering authentic flavors</p>
                        </div>
                    ...
                    <div>
                        <div className="mb-12 text-center">
                            <h3 className="text-dark mb-4 text-3xl font-bold md:text-4xl">
                                <span className="text-primary">How</span> to Get There
                            </h3>
                        </div>
