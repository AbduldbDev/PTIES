...
export default function PrivacyPolicy() {
    ...
    const title = 'Pakil Tourism | Privacy Policy';
    const description =
                ...
                <div className="terms-container container mx-auto px-4">
                    ...
                    <div className="rounded-2xl bg-white p-6 shadow-lg md:p-8 lg:p-12">
                        ...
                        <div className="mb-12">
                            <div className="mb-4 text-center">
                                <p className="text-base text-gray-700 md:text-lg">
                                    ...
                                    personal information in compliance with the Data Privacy Act of 2012 (Republic Act No. 10173) of the Republic of
                                    the Philippines.
                                </p>
                        ...
                        <div className="mb-12">
                            ...
                            <div className="space-y-4 text-sm text-gray-700 md:text-base lg:pl-14">
                                <ul className="ml-4 list-inside list-disc space-y-2">
                                    ...
                                    <li>
                                        Data related to rewards and transactions may be retained longer if required for auditing or legal compliance.
                                    </li>
                        ...
                        <div className="mb-12">
                            ...
                            <div className="space-y-4 text-sm text-gray-700 md:text-base lg:pl-14">
                                <p>
                                    PTIES may use cookies and analytics tools to improve user experience and gather site traffic insights. Cookies do
                                    not collect personal information and can be disabled in your browser settings if preferred.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="mb-12">
                            ...
                            <div className="space-y-4 text-sm text-gray-700 md:text-base lg:pl-14">
                                <p>
                                    This Privacy Policy may be updated periodically to reflect changes in system features or legal requirements. Any
                                    major changes will be announced through the PTIES website or via registered email.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="mt-12 rounded-xl border border-primary/20 bg-primary/5 p-6">
                            <div className="text-center">
                                ...
                                <p className="mb-6 text-sm text-gray-700 md:text-base">
                                    By using the PTIES platform, you acknowledge that you have read and understood this Privacy Policy and consent to
