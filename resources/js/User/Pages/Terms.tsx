...
export default function GeneralTerms() {
    ...
    const title = 'Pakil Tourism | Terms and Conditions';
    const description =
                    ...
                    <div className="rounded-2xl bg-white p-6 shadow-lg md:p-8 lg:p-12">
                        ...
                        <div className="mb-12">
                            <div className="mb-4 text-center">
                                <p className="text-base text-gray-700 md:text-lg">
                                    Welcome to the Pakil Tourism Information & Engagement System (PTIES). By accessing or using this website, you
                                    agree to comply with and be bound by the following Terms and Conditions. If you do not agree, please refrain from
                                    using the site.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="mb-12">
                            ...
                            <div className="space-y-4 text-sm text-gray-700 md:text-base lg:pl-14">
                                <p>
                                    By browsing or using PTIES, you agree to these Terms and Conditions, our Privacy Policy, and any other legal
                                    notices posted on the site. PTIES may revise these terms at any time without prior notice.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="mb-12">
                            ...
                            <div className="space-y-4 text-sm text-gray-700 md:text-base lg:pl-14">
                                ...
                                <p>
                                    The platform also includes interactive features such as event listings, gamification activities, and the Social
                                    Wall for community engagement.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="mb-12">
                            ...
                            <div className="space-y-4 text-sm text-gray-700 md:text-base lg:pl-14">
                                <p>
                                    All content, designs, logos, graphics, and materials found on PTIES are the property of the Municipality of Pakil
                        ...
                        <div className="mb-12">
                            ...
                            <div className="space-y-4 text-sm text-gray-700 md:text-base lg:pl-14">
                                ...
                                <p>
                                    By submitting content, you grant PTIES a non-exclusive, royalty-free license to display and use that content
                                    within the system.
                                </p>
                                <p>
                                ...
                                <p>
                                    PTIES reserves the right to remove or moderate any content that violates these standards or community guidelines.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="mb-12">
                            ...
                            <div className="space-y-4 text-sm text-gray-700 md:text-base lg:pl-14">
                                ...
                                <p>
                                    The Municipality of Pakil reserves the right to modify or discontinue any part of the website without prior
                                    notice.
                                </p>
                            </div>
                        </div>
