...
export default function SellerTerms() {
    ...
    const title = 'Pakil Tourism | Seller Terms and Conditions';
    const description =
                    ...
                    <div className="rounded-2xl bg-white p-6 shadow-lg md:p-8 lg:p-12">
                        ...
                        <div className="mb-12">
                            ...
                            <div className="space-y-4 text-sm text-gray-700 md:text-base lg:pl-14">
                                ...
                                <p>
                                    ...
                                    within PTIES. By creating a Seller Account, you acknowledge that you have read, understood, and agree to comply
                                    with these Terms, as well as all applicable laws, ordinances, and the policies of the{' '}
                                    <strong>Pakil Tourism Office</strong> and the
                        ...
                        <div className="mb-12">
                            ...
                            <div className="space-y-4 text-sm text-gray-700 md:text-base lg:pl-14">
                                ...
                                <p>
                                    <strong>2.4.</strong> The Office may deny or revoke a Seller's registration if requirements are incomplete,
                                    falsified, or found inconsistent with the goals of PTIES.
                                </p>
                                <p>
                        ...
                        <div className="mb-12">
                            ...
                            <div className="space-y-4 text-sm text-gray-700 md:text-base lg:pl-14">
                                ...
                                <p>
                                    ...
                                    <strong> does not process or manage online transactions, orders, or payments</strong>. Any purchases or exchanges
                                    of goods that may arise are to be conducted <strong>outside the platform</strong> and at the discretion of the
                                    parties involved.
                                </p>
                                <p>
                        ...
                        <div className="mb-12">
                            ...
                            <div className="space-y-4 text-sm text-gray-700 md:text-base lg:pl-14">
                                <p>
                                    <strong>4.1.</strong> Sellers are solely responsible for ensuring the accuracy, quality, and appropriateness of
                                    all content uploaded, including product descriptions, images, and pricing.
                                </p>
                                <p>
                                    <strong>4.2.</strong> All content must comply with applicable copyright, trademark, and intellectual property
                                    laws.
                                </p>
                                <p>
                                ...
                                <p>
                                    <strong>4.4.</strong> Product listings may be temporarily disabled during content verification, maintenance, or
                                    upon request by the Tourism Office.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="mb-12">
                            ...
                            <div className="space-y-4 text-sm text-gray-700 md:text-base lg:pl-14">
                                ...
                                <p>
                                    <strong>5.2.</strong> The personal and business information collected from Sellers — such as names, contact
                                    details, business documents, and listings — shall be used solely for legitimate purposes related to account
                                    management, vendor verification, and platform operations.
                                </p>
                                <p>
                        ...
                        <div className="mb-12">
                            ...
                            <div className="space-y-4 text-sm text-gray-700 md:text-base lg:pl-14">
                                ...
                                <p>
                                    <strong>6.3.</strong> Sellers shall comply with all local ordinances, business regulations, and consumer
                                    protection laws.
                                </p>
                                <p>
                                    <strong>6.4.</strong> In the event of customer feedback or complaints, Sellers are expected to respond promptly
                                    and respectfully.
                                </p>
                                <p>
                        ...
                        <div className="mb-12">
                            ...
                            <div className="space-y-4 text-sm text-gray-700 md:text-base lg:pl-14">
                                <p>
                                    ...
                                    <strong> Pakil Tourism Office</strong> reserves the right to monitor Seller activity to ensure compliance with
                                    these Terms.
                                </p>
                                <p>
                                ...
                                <p>
                                    <strong>7.3.</strong>A Seller whose account has been terminated may reapply for registration, subject to
                                    revalidation and approval by the <strong>Pakil Tourism Office</strong>.
                                </p>
                            </div>
                        </div>
                        <div className="mb-12">
                            ...
                            <div className="space-y-4 text-sm text-gray-700 md:text-base lg:pl-14">
                                ...
                                <p>
                                    ...
                                    <strong> information and promotional tool</strong>, and does not guarantee the accuracy, completeness, or
                                    availability of the products listed.
                                </p>
                                <p>
                                    <strong>8.3.</strong> PTIES shall not be responsible for product quality, pricing, shipping, payment issues, or
                                    any private arrangements between Sellers and buyers.
                                </p>
                                <p>
                                    <strong>8.4.</strong> The platform is provided “as is” and “as available,” and may occasionally be unavailable due
                        ...
                        <div className="mb-12">
                            ...
                            <div className="space-y-4 text-sm text-gray-700 md:text-base lg:pl-14">
                                <p>
                                    ...
                                    Sellers will be notified of significant changes via the platform or through their registered email. Continued use
                                    of PTIES after such updates constitutes acceptance of the revised Terms.
                                </p>
                            </div>
                        </div>
                        <div className="mb-12">
                            ...
                            <div className="space-y-4 text-sm text-gray-700 md:text-base lg:pl-14">
                                <p>
                                    ...
                                    <strong> Republic of the Philippines</strong>. Any disputes shall be settled in the appropriate courts located in
                                    the
                        ...
                        <div className="mt-12 rounded-xl border border-primary/20 bg-primary/5 p-6">
                            <div className="text-center">
                                ...
                                <p className="mb-6 text-sm text-gray-700 md:text-base">
                                    By registering as a Seller and continuing to use the PTIES platform, you acknowledge that you have read,
                                    understood, and agree to comply with these Terms and Conditions for Sellers.
                                </p>
